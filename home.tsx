...
const nav = [
  ...
  { label: "Passport", pa: "ਪਾਸਪੋਰਟ", hi: "पासपोर्ट", href: "#passport" },
...
const steps = [
  ...
  { icon: FileCheck2, title: "Issue the passport", pa: "ਪਾਸਪੋਰਟ ਜਾਰੀ ਕਰੋ", hi: "पासपोर्ट जारी करें", body: "Geo-tag, weight, payout and certified buyer are recorded per pickup.", bodyPa: "ਹਰ ਚੁੱਕਾਈ ਲਈ ਜੀਓ-ਟੈਗ, ਵਜ਼ਨ, ਭੁਗਤਾਨ ਅਤੇ ਤਸਦੀਕਸ਼ੁਦਾ ਖਰੀਦਦਾਰ ਦਰਜ ਹੁੰਦੇ ਹਨ।", bodyHi: "हर उठान के लिए जियो-टैग, वज़न, भुगतान और सत्यापित खरीदार दर्ज होते हैं।" },
  ...
  { icon: ScanLine, title: "Consumers verify", pa: "ਗਾਹਕ ਤਸਦੀਕ ਕਰਦੇ ਹਨ", hi: "उपभोक्ता सत्यापित करते हैं", body: "A QR on the finished product opens the verified seal and custody ledger.", bodyPa: "ਤਿਆਰ ਉਤਪਾਦ ਦਾ QR ਤਸਦੀਕਸ਼ੁਦਾ ਮੋਹਰ ਅਤੇ ਹਿਰਾਸਤ ਰਿਕਾਰਡ ਖੋਲ੍ਹਦਾ ਹੈ।", bodyHi: "तैयार उत्पाद का QR सत्यापित मुहर और अभिरक्षा रिकॉर्ड खोलता है।" },
];
      ...
      <main id="top">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
                {text("StubbleX connects geolocated farmer clusters and FPOs with industries that need crop residue — coordinating baling and pickup in the 20-day harvest window, paying farmers at the weighbridge, and issuing a Digital Product Passport for every tonne.", "StubbleX ਸਥਾਨ-ਚਿੰਨ੍ਹਿਤ ਕਿਸਾਨ ਕਲੱਸਟਰਾਂ ਅਤੇ FPO ਨੂੰ ਪਰਾਲੀ ਦੀ ਲੋੜ ਵਾਲੇ ਉਦਯੋਗਾਂ ਨਾਲ ਜੋੜਦਾ ਹੈ—20 ਦਿਨਾਂ ਦੀ ਵਾਢੀ ਮਿਆਦ ਵਿੱਚ ਗੱਠਾਂ ਅਤੇ ਚੁੱਕਾਈ ਦਾ ਤਾਲਮੇਲ, ਵੇਅਬ੍ਰਿਜ ਉੱਤੇ ਕਿਸਾਨ ਭੁਗਤਾਨ ਅਤੇ ਹਰ ਟਨ ਲਈ ਡਿਜ਼ਿਟਲ ਪ੍ਰੋਡਕਟ ਪਾਸਪੋਰਟ।", "StubbleX स्थान-चिह्नित किसान क्लस्टरों और FPO को पराली की जरूरत वाले उद्योगों से जोड़ता है—20 दिन की कटाई अवधि में गांठ और उठान समन्वय, वेब्रिज पर किसान भुगतान और हर टन के लिए डिजिटल प्रोडक्ट पासपोर्ट।")}
              </p>
        ...
        <Section id="passport" className="border-t border-border bg-secondary">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              <p className="eyebrow">{text("The Digital Product Passport", "ਡਿਜ਼ਿਟਲ ਪ੍ਰੋਡਕਟ ਪਾਸਪੋਰਟ", "डिजिटल प्रोडक्ट पासपोर्ट")}</p>
              <h2 className="mt-4 text-3xl md:text-4xl">{text("One scan, and the claim stops being marketing.", "ਇੱਕ ਸਕੈਨ, ਅਤੇ ਦਾਅਵਾ ਸਿਰਫ਼ ਮਾਰਕੀਟਿੰਗ ਨਹੀਂ ਰਹਿੰਦਾ।", "एक स्कैन, और दावा सिर्फ़ मार्केटिंग नहीं रहता।")}</h2>
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">{text("Every transaction on StubbleX mints a geo-tagged, tamper-resistant record: the originating field, the weight collected, what the farmer was paid, and the certified buyer. Manufacturers carry that passport on the finished product as a QR code.", "StubbleX ਦਾ ਹਰ ਲੈਣ-ਦੇਣ ਜੀਓ-ਟੈਗ ਅਤੇ ਛੇੜਛਾੜ-ਰੋਧੀ ਰਿਕਾਰਡ ਬਣਾਉਂਦਾ ਹੈ: ਮੂਲ ਖੇਤ, ਇਕੱਠਾ ਵਜ਼ਨ, ਕਿਸਾਨ ਭੁਗਤਾਨ ਅਤੇ ਤਸਦੀਕਸ਼ੁਦਾ ਖਰੀਦਦਾਰ। ਨਿਰਮਾਤਾ ਇਸ ਪਾਸਪੋਰਟ ਨੂੰ QR ਰੂਪ ਵਿੱਚ ਉਤਪਾਦ ਉੱਤੇ ਲਗਾਉਂਦੇ ਹਨ।", "StubbleX का हर लेन-देन जियो-टैग और छेड़छाड़-रोधी रिकॉर्ड बनाता है: मूल खेत, एकत्र वज़न, किसान भुगतान और सत्यापित खरीदार। निर्माता इस पासपोर्ट को QR रूप में उत्पाद पर लगाते हैं।")}</p>
              <dl className="mt-8 grid gap-6 sm:grid-cols-3">
                {[[text("Verified seal","ਤਸਦੀਕਸ਼ੁਦਾ ਮੋਹਰ","सत्यापित मुहर"),text("Issued only against a weighbridge record.","ਸਿਰਫ਼ ਵੇਅਬ੍ਰਿਜ ਰਿਕਾਰਡ ਉੱਤੇ ਜਾਰੀ।","केवल वेब्रिज रिकॉर्ड पर जारी।")],[text("Impact numbers","ਪ੍ਰਭਾਵ ਅੰਕੜੇ","प्रभाव आँकड़े"),text("Tonnage diverted and transport distance per unit.","ਬਚਾਈ ਮਾਤਰਾ ਅਤੇ ਪ੍ਰਤੀ ਯੂਨਿਟ ਆਵਾਜਾਈ ਦੂਰੀ।","बचाई मात्रा और प्रति यूनिट परिवहन दूरी।")],[text("Custody ledger","ਹਿਰਾਸਤ ਲੇਜ਼ਰ","अभिरक्षा लेज़र"),text("Field → baler → weighbridge → mill → SKU.","ਖੇਤ → ਬੇਲਰ → ਵੇਅਬ੍ਰਿਜ → ਮਿੱਲ → SKU.","खेत → बेलर → वेब्रिज → मिल → SKU.")]].map(([t, d]) => (
                  <div key={t}>
              ...
              <p className="mt-8 text-xs text-muted-foreground">{text("Illustrative passport — sample data shown for demonstration.", "ਨਮੂਨਾ ਪਾਸਪੋਰਟ—ਡੈਮੋ ਲਈ ਉਦਾਹਰਨ ਡਾਟਾ।", "उदाहरण पासपोर्ट—डेमो के लिए नमूना डेटा।")}</p>
            </div>
            <PassportMock />
          </div>
        </Section>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <ul className="mt-8 space-y-5">
                {[[text("No equipment to buy","ਕੋਈ ਸਾਜ਼ੋ-ਸਾਮਾਨ ਨਹੀਂ ਖਰੀਦਣਾ","कोई उपकरण नहीं खरीदना"),text("Balers, rakes and trucks are arranged for you through existing operators.","ਮੌਜੂਦਾ ਓਪਰੇਟਰਾਂ ਰਾਹੀਂ ਬੇਲਰ, ਰੇਕ ਅਤੇ ਟਰੱਕ ਦਾ ਪ੍ਰਬੰਧ ਹੁੰਦਾ ਹੈ।","मौजूदा ऑपरेटरों से बेलर, रेक और ट्रक की व्यवस्था होती है।")],[text("Paid at the weighbridge","ਵੇਅਬ੍ਰਿਜ ਉੱਤੇ ਭੁਗਤਾਨ","वेब्रिज पर भुगतान"),text("Payouts are advance-funded, so settlement does not wait on the mill.","ਭੁਗਤਾਨ ਅਗਾਊਂ ਫੰਡ ਹੁੰਦੇ ਹਨ, ਇਸ ਲਈ ਮਿੱਲ ਦੀ ਉਡੀਕ ਨਹੀਂ।","भुगतान अग्रिम फंड होते हैं, इसलिए मिल का इंतज़ार नहीं।")],[text("Cluster scheduling","ਕਲੱਸਟਰ ਸਮਾਂ-ਸੂਚੀ","क्लस्टर समय-सारणी"),text("Your FPO registers volumes before harvest and gets a pickup slot in the window.","ਤੁਹਾਡਾ FPO ਵਾਢੀ ਤੋਂ ਪਹਿਲਾਂ ਮਾਤਰਾ ਦਰਜ ਕਰਕੇ ਚੁੱਕਾਈ ਸਮਾਂ ਲੈਂਦਾ ਹੈ।","आपका FPO कटाई से पहले मात्रा दर्ज कर उठान समय लेता है।")],[text("A clean field on time","ਸਮੇਂ ਸਿਰ ਸਾਫ਼ ਖੇਤ","समय पर साफ़ खेत"),text("Residue leaves the plot in days, ready for the next sowing.","ਪਰਾਲੀ ਕੁਝ ਦਿਨਾਂ ਵਿੱਚ ਖੇਤ ਤੋਂ ਨਿਕਲਦੀ ਹੈ ਅਤੇ ਅਗਲੀ ਬਿਜਾਈ ਲਈ ਤਿਆਰ ਹੁੰਦਾ ਹੈ।","पराली कुछ दिनों में खेत से निकलती है और अगली बुवाई के लिए तैयार होता है।")]].map(([t, d]) => (
            ...
            <div className="rounded-lg border border-border bg-card p-6 md:p-8">
              ...
              <ol className="mt-5 space-y-5">
                {[text("Share your village, FPO and approximate paddy acreage.","ਆਪਣਾ ਪਿੰਡ, FPO ਅਤੇ ਲਗਭਗ ਝੋਨਾ ਰਕਬਾ ਦੱਸੋ।","अपना गाँव, FPO और लगभग धान रकबा बताएं।"),text("A field coordinator confirms cluster mapping and expected tonnage.","ਫ਼ੀਲਡ ਕੋਆਰਡੀਨੇਟਰ ਕਲੱਸਟਰ ਅਤੇ ਉਮੀਦਵਾਰ ਮਾਤਰਾ ਦੀ ਪੁਸ਼ਟੀ ਕਰਦਾ ਹੈ।","फील्ड समन्वयक क्लस्टर और अनुमानित मात्रा की पुष्टि करता है।"),text("You receive a pickup slot and payout rate before harvest begins.","ਵਾਢੀ ਤੋਂ ਪਹਿਲਾਂ ਚੁੱਕਾਈ ਸਮਾਂ ਅਤੇ ਭੁਗਤਾਨ ਦਰ ਮਿਲਦੀ ਹੈ।","कटाई से पहले उठान समय और भुगतान दर मिलती है।"),text("Bales are weighed, you are paid, and the passport is issued.","ਗੱਠਾਂ ਦਾ ਵਜ਼ਨ, ਤੁਹਾਡਾ ਭੁਗਤਾਨ ਅਤੇ ਪਾਸਪੋਰਟ ਜਾਰੀ ਹੁੰਦਾ ਹੈ।","गांठों का वज़न, आपका भुगतान और पासपोर्ट जारी होता है।")].map((t, i) => (
        ...
        <Section id="buyers" className="border-t border-border bg-secondary">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">{text("Board, plate and packaging producers commit volumes ahead of the season and draw from clusters within 30–50 km. Each consignment arrives with its passport, ready to carry onto your SKUs.", "ਬੋਰਡ, ਪਲੇਟ ਅਤੇ ਪੈਕੇਜਿੰਗ ਨਿਰਮਾਤਾ ਸੀਜ਼ਨ ਤੋਂ ਪਹਿਲਾਂ ਮਾਤਰਾ ਪੱਕੀ ਕਰਕੇ 30–50 ਕਿਮੀ ਦੇ ਕਲੱਸਟਰਾਂ ਤੋਂ ਲੈਂਦੇ ਹਨ। ਹਰ ਖੇਪ ਪਾਸਪੋਰਟ ਨਾਲ ਆਉਂਦੀ ਹੈ।", "बोर्ड, प्लेट और पैकेजिंग निर्माता सीज़न से पहले मात्रा तय कर 30–50 किमी के क्लस्टरों से लेते हैं। हर खेप पासपोर्ट के साथ आती है।")}</p>
            </div>
            <div className="grid gap-px overflow-hidden rounded-lg border border-border bg-border sm:grid-cols-2">
              {[[text("Predictable supply","ਪੱਕੀ ਸਪਲਾਈ","तय आपूर्ति"),text("Pre-season commitments across multiple clusters reduce single-source risk.","ਕਈ ਕਲੱਸਟਰਾਂ ਦੀ ਅਗਾਊਂ ਵਚਨਬੱਧਤਾ ਇੱਕ ਸਰੋਤ ਦਾ ਜੋਖਮ ਘਟਾਉਂਦੀ ਹੈ।","कई क्लस्टरों की अग्रिम प्रतिबद्धता एक स्रोत का जोखिम घटाती है।")],[text("Lower freight","ਘੱਟ ਭਾੜਾ","कम भाड़ा"),text("Radius matching keeps haulage short and costs stable.","ਦਾਇਰਾ ਮੇਲ ਆਵਾਜਾਈ ਛੋਟੀ ਅਤੇ ਲਾਗਤ ਸਥਿਰ ਰੱਖਦਾ ਹੈ।","दायरा मिलान ढुलाई छोटी और लागत स्थिर रखता है।")],[text("Audit-ready records","ਆਡਿਟ ਲਈ ਤਿਆਰ ਰਿਕਾਰਡ","ऑडिट-तैयार रिकॉर्ड"),text("Weighbridge-backed provenance for ESG and buyer diligence.","ESG ਅਤੇ ਖਰੀਦਦਾਰ ਜਾਂਚ ਲਈ ਵੇਅਬ੍ਰਿਜ-ਅਧਾਰਿਤ ਮੂਲ।","ESG और खरीदार जाँच के लिए वेब्रिज-आधारित मूल।")],[text("Consumer trust, built in","ਗਾਹਕ ਭਰੋਸਾ ਅੰਦਰੋਂ","उपभोक्ता भरोसा भीतर से"),text("A per-SKU passport turns sourcing into a scannable claim.","ਹਰ SKU ਦਾ ਪਾਸਪੋਰਟ ਸੋਰਸਿੰਗ ਨੂੰ ਸਕੈਨਯੋਗ ਸਬੂਤ ਬਣਾਉਂਦਾ ਹੈ।","हर SKU का पासपोर्ट सोर्सिंग को स्कैन योग्य प्रमाण बनाता है।")]].map(([t, d]) => (
        ...
        <Section id="contact" className="border-t border-border">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground">{text("We are onboarding farmer clusters and FPOs in Punjab, industrial buyers of paddy residue, and partners interested in the passport layer.", "ਅਸੀਂ ਪੰਜਾਬ ਦੇ ਕਿਸਾਨ ਕਲੱਸਟਰਾਂ, FPO, ਝੋਨੇ ਦੀ ਪਰਾਲੀ ਦੇ ਉਦਯੋਗਿਕ ਖਰੀਦਦਾਰਾਂ ਅਤੇ ਪਾਸਪੋਰਟ ਭਾਗੀਦਾਰਾਂ ਨੂੰ ਜੋੜ ਰਹੇ ਹਾਂ।", "हम पंजाब के किसान क्लस्टरों, FPO, धान-पराली के औद्योगिक खरीदारों और पासपोर्ट भागीदारों को जोड़ रहे हैं।")}</p>
