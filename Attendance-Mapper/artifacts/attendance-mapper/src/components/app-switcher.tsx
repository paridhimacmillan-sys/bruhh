/**
 * AppSwitcher.tsx
 * Drop this into: artifacts/attendance-mapper/src/components/app-switcher.tsx
 * Then add <AppSwitcher /> to the bottom of your sidebar component
 */
        ...
        <div className="mt-1 rounded-xl border border-border bg-card shadow-lg overflow-hidden">
          {APPS.map((app) => (
            <a
              ...
              target={app.current ? undefined : "_self"}
