  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
        ...
        <aside className="p-5">
          {!selected ? <div className="py-12 text-center"><p className="font-display text-xl">Select an application</p><p className="mt-2 text-sm text-muted-foreground">Review details and record the StubbleX decision here.</p></div> : <ReviewApplication
