    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto w-full max-w-7xl px-5 py-8 md:px-8 md:py-12">
        ...
        <section className="mt-6 overflow-hidden rounded-lg border border-border bg-card" aria-labelledby="batch-ledger-title">
          ...
          {activeTab === "batches" ? <BatchTable batches={batches} canManage={canManageBatches} onMarkPaid={markPaid} onPreviewSms={setSmsBatch} pendingBatchId={pendingBatchId} /> : <OrderTable orders={orders} canDecide={canManageBatches} />}
        </section>
      </main>
